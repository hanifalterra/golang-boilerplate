...
func (uc *productUseCase) Update(ctx context.Context, id uint, product *models.Product) error {
	if product == nil {
		return errors.New("product is nil")
	}
...
func (uc *productUseCase) FetchOne(ctx context.Context, id uint) (*models.Product, error) {
